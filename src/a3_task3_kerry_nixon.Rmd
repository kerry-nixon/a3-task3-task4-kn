...
**Observations and Analysis:** When reviewing the exploratory histograms, it appears that the distribution of the sample for purple urchins is positively skewed, while the sample distribution for red urchins looks to be more normally distributed. When viewing the sample distribution box plots there appears to be a fair amount of variance between the samples. The red urchin sample has more variance within the sample relative to the purple urchin sample. The difference in median diameter is  2.5 cm, which represents a sizable 43.47% difference in median diameter between the two samples. Likewise, the sample means are approximately 2.31 cm apart, representing a 41.07% difference in mean urchin diameter. This would indicate that unlikely that the samples are from the same population, and that the differences in mean and median diameters in the summary table are reflective of true differences between the urchin populations (i.e. it is possible that red urchins are larger than purple urchins). This is particularly true given the large sample sizes used to analyze both species. 
...
#### Exploratory Graph of Annual Purple Urchin Counts by Site
